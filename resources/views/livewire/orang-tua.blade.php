        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                    {{ $isUpdate ? 'Update Data Guru' : 'Tambah Orang Tua' }}
                </h2>
                ...
                <form wire:submit.prevent="{{ $isUpdate ? '' : 'store' }}" class="mt-6 space-y-6">
                    ...
                    <div>
                        <label for="siswa_id" class="block font-medium text-sm text-gray-700 dark:text-gray-300">Wali
                            Siswa</label>
                        <select id="siswa_id"
                            class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full"
                            wire:model.defer="siswa_id" wire:key="kelas-{{ $iteration }}">
                            <option value="">-- Pilih Siswa --</option>
                            @foreach ($kelasList as $siswa)
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Daftar Orang Tua</h2>
